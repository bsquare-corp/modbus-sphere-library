...
/// <summary>
/// Turn on the Half Duplex line for this Uart.
/// Warning - only one Uart may be configured for Half Duplex.
/// The last one enabled will be the one that modifies the GPIO.
/// </summary>
void Uart_EnableHalfDuplex(UartId id);

/// <summary>
/// Turn off the Half Duplex line for this Uart.
/// The GPIO pin will remain configured for output.
/// Depending on the timing of this call,
/// the GPIO pin could be in either state.
/// </summary>
void Uart_DisableHalfDuplex(UartId id);

/// <summary>
/// Toggle the GPIO pin off if a write has already taken place.
/// </summary>
